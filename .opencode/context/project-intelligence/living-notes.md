...
**Branch state:** `main` includes Phase 8 documentation hardening merges (`#33`, `#34`) on top of the Phase 7 remediation sequence. Active Phase 9 branch: `feature/phase-9-host-reconciler-fix`.
