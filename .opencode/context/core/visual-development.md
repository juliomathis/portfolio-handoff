...
| **Design system** | `.opencode/context/project-wiki/design-system.md` | - | - |
| **UI standards** | `.opencode/context/core/standards/code-quality.md` | - | - |
| **Animation patterns** | `.opencode/context/core/workflows/design-iteration.md` | - | - |
...
- **Agent Capabilities (Arcitecto)**: `.opencode/agent/core/openagent.md`
