...
```bash
read(filePath=".opencode/context")
```
...
read(filePath=".opencode/context/{category}")
...
.opencode/context/
├── core/standards/
│   ├── code-quality.md ⭐ FOUND
│   ├── documentation.md ⭐ FOUND
│   └── code-analysis.md
...
### Files to Load (Priority Order)
1. `.opencode/context/core/standards/code-quality.md` - CRITICAL for all code implementation
2. `.opencode/context/core/standards/documentation.md` - Formatting and documentation rules
3. `.opencode/context/core/standards/code-analysis.md` - Additional analysis guidance
...
### Additional Context Available
If you need more information on:
- **Testing standards** → Check `.opencode/context/core/standards/test-coverage.md`
- **Design patterns** → Check `.opencode/context/core/standards/code-analysis.md`
```
...
**Primary Location**: `.opencode/context/project-wiki/`
**Categories Found**: documentation, workflows, runbooks
**Total Context Files**: 8

**Structure**:
```
.opencode/context/project-wiki/
├── index.md ⭐ FOUND
├── operations.md ⭐ FOUND
└── testing.md ⭐ FOUND
...
#### ⭐⭐⭐⭐⭐ Contributing Guide
**Path**: `.opencode/context/project-wiki/index.md`
**Purpose**: Main project documentation index and navigation

**Key Findings**:
- Start from the project wiki index for canonical docs
- Follow code standards in `.opencode/context/core/standards/code-quality.md`
- Use operations/testing pages for runbook and validation expectations
- Keep legacy docs as temporary backup only
- Use workflow docs for review and delegation patterns

**Relevant Sections**:
- **Index Navigation** (top section) - Entry point and canonical links
- **Operations Runbook** - Step-by-step operational process
- **Testing Guidance** - Validation expectations
- **Code Review Workflow** - Review expectations

**Action Items**:
- Read canonical docs from `.opencode/context/project-wiki/index.md`
- Load core standards before implementation
- Follow project workflow docs for review and validation
...
### Files to Load (Priority Order)
1. `.opencode/context/project-wiki/index.md` - Main documentation index
2. `.opencode/context/project-wiki/operations.md` - Operational workflow guide
3. `.opencode/context/core/workflows/review.md` - Code review expectations

### Key Takeaways
- Canonical docs are under `.opencode/context/project-wiki/`
- Validation and testing guidance is centralized in project wiki pages
- Code review workflow is documented in core workflows

### Next Steps
1. Open `.opencode/context/project-wiki/index.md`
2. Read the code standards before implementing
3. Follow operational and testing guidance in project wiki pages
4. Use review workflow before finalizing changes

### Additional Context Available
If you need more information on:
- **Code standards** → Check `.opencode/context/core/standards/code-quality.md`
- **Testing guidelines** → Check `.opencode/context/core/standards/test-coverage.md`
```
...
2. Look for canonical project wiki index
...
- `.opencode/context/project-wiki/index.md` - {if exists, summarize}
